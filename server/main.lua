...
RegisterNetEvent('qb-scrapyard:deleteOwnerVehicle', function(plate)
...
function GenerateVehicleList()
    Config.CurrentVehicles = {}
        local randVehicle = Config.Vehicles
        if not IsInList(randVehicle) then
            Config.CurrentVehicles = randVehicle
        end
    TriggerClientEvent("qb-scapyard:client:setNewVehicles", -1, Config.CurrentVehicles)
end
...
--    coords = vector4(2352.8, 3137.08, 48.21, 163.53),
--    minusOne = true,
--    freeze = true,
 --   invincible = true,
 --   blockevents = true,
